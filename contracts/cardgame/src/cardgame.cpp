...
ACTION cardgame::playcard(name username, uint8_t player_card_idx)
{
  ...
  check(user.game_data.status == ONGOING, "playcard: This game has ended. Please start a new one");
  check(user.game_data.selected_card_player == 0, "playcard: The player has played his card this turn!");
